...
// 布蘭特 − WTI 價差:布蘭特反映國際海運油市、WTI 反映美國本土。頁岩油時代的常態
// 是布蘭特高 $2–6(品質差 + 美國原油出口運輸成本);明顯走高 = 國際端地緣/供給溢酬,
// 收斂到 $2 以下 = 國際供給疑慮低(或美國本土偏緊),倒掛(<0)罕見、屬異常訊號
function oilSpreadText() {
  ...
  const verdict = spread < 0 ? '罕見倒掛——美國本土供給相對偏緊或全球需求疲弱'
    : spread < 2 ? '低於常態區間,國際端供給疑慮低'
    : spread <= 6 ? '落在常態區間($2–6,品質與運輸成本),無特別地緣訊號'
    : spread <= 10 ? '高於常態區間,地緣/供給溢酬升溫'
    : '地緣風險溢酬顯著,國際油市明顯偏緊';
